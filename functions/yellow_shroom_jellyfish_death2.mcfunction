...
execute if block ~-2~-1~-2 air run execute if block ~-2~~-2 edx:cave_mycelium run fill ~-2~-1~-2 ~-2~-1~-2 edx:mycelium_grass replace air  
execute if block ~-1~-1~-2 air run execute if block ~-1~~-2 edx:cave_mycelium run fill ~-1~-1~-2 ~-1~-1~-2 edx:yellow_spore_bag replace air
...
execute if block ~~-1~3 air run execute if block ~~~3 edx:cave_mycelium run fill ~~-1~3 ~~-1~3 edx:mycelium_grass replace air
function yellow_spores_particles
effect @e[r=0.5,type=player] haste 10 0
effect @e[r=0.5,type=player] fatal_poison 5 0
execute if block ~~-1~ air run fill ~~~ ~~~ edx:cave_mycelium replace minecraft:stone 
