...
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~0 ~ run tp @s ^-4.5 ^ ^5.9
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~1.6 ~ run tp @s ^-3.7 ^ ^4.5
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~2.9 ~ run tp @s ^-3.2 ^ ^2.5
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~2.9 ~ run tp @s ^3.2 ^ ^2.5
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~1.6 ~ run tp @s ^3.7 ^ ^4.5
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~0 ~ run tp @s ^4.5 ^ ^5.9

execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-1 ~ run tp @s ^-6.5 ^ ^10.5
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-1 ~ run tp @s ^-6.0 ^ ^9
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-1 ~ run tp @s ^-5.5 ^ ^7.5
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-1 ~ run tp @s ^5.5 ^ ^7.5
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-1 ~ run tp @s ^6.0 ^ ^9
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-1 ~ run tp @s ^6.5 ^ ^10.5
