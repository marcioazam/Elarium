...
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~2.5 ~ run tp @s ^-7.5 ^ ^3.5
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~2.7 ~ run tp @s ^-6 ^ ^3.0
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~3 ~ run tp @s ^-4.2 ^ ^2.4
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~3 ~ run tp @s ^4.2 ^ ^2.4
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~2.7 ~ run tp @s ^6 ^ ^3.0
execute as @e[type=xp:endboss_hitbox,tag=upper_arm,r=1,c=1] at @s positioned ~ ~2.5 ~ run tp @s ^7.5 ^ ^3.5

execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~2.5 ~ run tp @s ^-9.2 ^ ^4
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~1 ~ run tp @s ^-9.2 ^ ^4
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-0.5 ~ run tp @s ^-9.2 ^ ^4
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~2.5 ~ run tp @s ^9.2 ^ ^4
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~1 ~ run tp @s ^9.2 ^ ^4
execute as @e[type=xp:endboss_hitbox,tag=lower_arm,r=1,c=1] at @s positioned ~ ~-0.5 ~ run tp @s ^9.2 ^ ^4

execute as @e[type=xp:endboss_hitbox,tag=body,r=1,c=1] at @s positioned ~ ~2 ~ run tp @s ^1 ^ ^1.5
execute as @e[type=xp:endboss_hitbox,tag=body,r=1,c=1] at @s positioned ~ ~2 ~ run tp @s ^-1 ^ ^1.5
