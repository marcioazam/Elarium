...
execute if block ~1~2~1 air run execute if block ~1~1~1 edx:cave_mycelium run fill ~1~2~1 ~1~2~1 edx:mycelium_grass replace air  
execute if block ~-1~2~ air run execute if block ~-1~1~ edx:cave_mycelium run fill ~-1~2~ ~-1~2~ edx:blue_spore_bag replace air  
...
execute if block ~~1~2 air run execute if block ~~~2 edx:cave_mycelium run fill ~~1~2 ~~1~2 edx:blue_mushroom replace air  
execute if block ~-1~1~-2 air run execute if block ~-1~~-2 edx:cave_mycelium run fill ~-1~1~-2 ~-1~1~-2 edx:mycelium_grass replace air  
